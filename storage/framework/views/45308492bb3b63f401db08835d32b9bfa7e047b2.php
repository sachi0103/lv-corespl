    ...
    <div class="card">
       ...
       <div class="card-body">
            ...
            <div class="form-group form-row">
                    ...
                    <div class="col-sm-7">
                        <input type="text" class="form-control" id="emp_same_time" value="<?php echo e(($user->companies) ? $user->companies->emp_same_time : ''); ?>" name="emp_same_time">
                    </div>
            </div>
            ...
            <div class="form-group form-row new_phone" <?php echo ($user->companies && $user->companies->new_phone == "Keep Existing Number") ? 'style="display:none;"' : '';?>>
                    ...
                    <div class="col-sm-2">
                        <input type="text" class="form-control" maxlength="3" id="new_area_code" value="<?php echo e(($user->companies) ? $user->companies->new_area_code : ''); ?>" name="new_area_code" require placeholder="Area Code">
                    </div>
                    <div class="col-sm-2">
                        <span style="background:gray"></span>
                    </div>
                    <div class="col-sm-3">
                        <input type="text" class="form-control" id="new_phone_last" value="<?php echo e(($user->companies) ? $user->companies->new_phone_last : ''); ?>" maxlength="4" name="new_phone_last" require placeholder="Last 4 digits">
                    </div>
            </div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('backend.layouts.dashboard.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/corespl/login.corespl.com/jsdgdshfewiqruqwrujdfhsxzmv/resources/views/backend/auth/profile.blade.php ENDPATH**/ ?>