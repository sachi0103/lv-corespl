      ...
      <div id="sidebar-menu">
         <ul class="sidebar-links custom-scrollbar">
            ...
            <li class="sidebar-list">
               <a href="<?php echo e(route('admin.dashboard')); ?>" class="sidebar-link sidebar-title <?php echo e(Route::currentRouteName()=='dashboard' ? 'active' : ''); ?>" style="cursor: pointer;">
            ...
            <li class="sidebar-list">
                ...
                <ul class="sidebar-submenu" style="display">
                    <li>
                       <a class="submenu-title" href="#">View Accounts<span class="sub-arrow"><i class="fa fa-angle-right"></i></span></a>
                    </li>
                </ul>
             </li>
             ...
             <li class="sidebar-list">
                ...
                <ul class="sidebar-submenu" style="display">
                    <li>
                       <a class="submenu-title" href="#">View Reports<span class="sub-arrow"><i class="fa fa-angle-right"></i></span>
                       </a>
                    </li>
                </ul>
             </li>
...
<?php /**PATH C:\xampp\htdocs\corespl.com\resources\views/backend/layouts/dashboard/sidebar.blade.php ENDPATH**/ ?>