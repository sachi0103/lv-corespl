                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-4">
                                <div class="pull-right"> 
                                    <a href="<?php echo e(route('admin.packages.create')); ?>" class="btn btn-primary">Create New</a>
                                </div>
                            </div>
                        </div>
                    </div>
                            ...
                            <tbody>
                                <?php $__empty_1 = true; $__currentLoopData = $packages; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $package): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                    <tr>
                                        ...
                                        <td><?php echo e(date('Y-m-d',strtotime($package->created_at))); ?></td>

                                        <td><?php echo e($package->number_of_packages); ?></td>

                                        <td><?php echo e($package->charge_per_package); ?></td>

                                        <td><?php echo e($package->total); ?></td>
                                    </tr>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('backend.layouts.dashboard.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\wamp\www\jayoffice\lv-corespl\resources\views/backend/package/index.blade.php ENDPATH**/ ?>