...
INSERT INTO `countries` (`code`, `name`, `currency_code`, `fips_code`, `iso_numeric`, `north`, `south`, `east`, `west`, `capital`, `continent_name`, `continent`, `languages`, `isoAlpha3`, `geonameId`) VALUES
