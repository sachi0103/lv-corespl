         ...
         <ul class="sidebar-links custom-scrollbar">
            ...
            <li class="sidebar-list">
                ...
                <ul class="sidebar-submenu" style="display:none">
                    <li>
                       <a class="submenu-title" href="{{route('admin.accounts.index')}}">View Accounts<span class="sub-arrow"><i class="fa fa-angle-right"></i></span></a>
                    </li>
                    <li>
                       <a class="submenu-title" href="{{route('admin.accounts.create')}}">Add Accounts<span class="sub-arrow"><i class="fa fa-angle-right"></i></span></a>
                    </li>
                </ul>
             </li>

             <li class="sidebar-list">
                <a class="sidebar-link sidebar-title"  href="{{route('admin.payment.index')}}">
             ...
             <li class="sidebar-list">
                ...
                <ul class="sidebar-submenu" style="display:none">
                    <li>
                       <a class="submenu-title" href="{{route('admin.reports.index')}}">View Reports<span class="sub-arrow"><i class="fa fa-angle-right"></i></span>
                       </a>
                    </li>
                </ul>
             </li>
