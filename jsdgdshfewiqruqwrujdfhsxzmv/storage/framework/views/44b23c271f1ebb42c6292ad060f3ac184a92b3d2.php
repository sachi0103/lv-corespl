                            ...
                            <table class="table">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td><?php echo e($account->allowed_minutes); ?></td>
                                        <td><?php echo e($account->remaining_minutes); ?></td>
                                        <td><?php echo e($account->number_of_selected_package); ?></td>
                                        <td><?php echo e($account->description); ?></td>
                                        <td><?php echo e($account->purchase_date); ?></td>
                                        <td><a href="<?php echo e(route('admin.accounts.user', [$account->id])); ?>">View Users</a></td>
                                    </tr>
...
<?php echo $__env->make('backend.layouts.dashboard.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/corespl/login.corespl.com/jsdgdshfewiqruqwrujdfhsxzmv/resources/views/backend/accounts/index.blade.php ENDPATH**/ ?>