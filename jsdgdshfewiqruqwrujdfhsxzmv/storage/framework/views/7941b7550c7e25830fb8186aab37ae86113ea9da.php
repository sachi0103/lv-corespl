                  ...
                  <div style="margin:3%">
                     ...
                     <form action="<?php echo e(route('contactus.save')); ?>" method="POST">
                        ...
                        <div class="form-group form-row new_phone">
                              ...
                              <div class="col-sm-2">
                              <span style="background:gray;width:100%;height:100%;" class="form-control">&nbsp;</span>
                              </div>
                              <div class="col-sm-3">
...
<?php echo $__env->make('backend.layouts.authentication.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\wamp\www\jayoffice\lv-corespl\jsdgdshfewiqruqwrujdfhsxzmv\resources\views/backend/auth/adminlogin.blade.php ENDPATH**/ ?>